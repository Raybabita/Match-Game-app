...
class MatchGame extends Component {
  ...
  renderPlayCard = () => {
    const {activeTabId, matchImageObject} = this.state
  ...
  render() {
    const {score, timer, isPlaying} = this.state

    return (
      <div className="app-container">
        <ul className="game-store-header">
          <li>
            <img
              className="app-logo"
              alt="website logo"
        ...
        {isPlaying ? this.renderPlayCard() : this.renderScoreCard()}
      </div>
    )
  }
}
